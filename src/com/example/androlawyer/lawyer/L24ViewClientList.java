...
public class L24ViewClientList extends Activity {
	...
	protected void onRestart() {
		...
		progress.show();
		l = (LinearLayout) findViewById(R.id.lstLcontactviewall_lawyer);
		
		nodatatv= (TextView) findViewById(R.id.L24NODATA);
		nodatatv.setVisibility(View.INVISIBLE);
		nodatall= (LinearLayout) findViewById(R.id.L24NODATALL);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_l24_view_client_list);
	...
	public void getClientName() {
		...
		try {
			...
			ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
					Client_names);
			ListView lv = (ListView) findViewById(R.id.lstLclientsviewall_lawyer);
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					Intent i = new Intent(getApplicationContext(), L24ViewClient.class);
