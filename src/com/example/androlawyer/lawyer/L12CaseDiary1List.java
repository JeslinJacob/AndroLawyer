...
public class L12CaseDiary1List extends Activity {
	...
	protected void onRestart() {
		...
		progress.show();
		l = (LinearLayout) findViewById(R.id.LLCaseViewDiaryList);

		nodatatv = (TextView) findViewById(R.id.L12NODATA);
		nodatatv.setVisibility(View.INVISIBLE);
		nodatall = (LinearLayout) findViewById(R.id.L12NODATALL);
	...
	public void getCaseid() {
		...
		try {
			...
			ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
					Case_ids);
			ListView lv = (ListView) findViewById(R.id.LstLLCaseViewDiaryList);
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
					...
					Intent i = new Intent(getApplicationContext(), L12CaseDiary2View.class);
	...
	public void nodata() {
		...
		// builder.setCancelable(false).setMessage("No Cases
		// !!").setPositiveButton("OK", dialogClickListener2).show();
	}
