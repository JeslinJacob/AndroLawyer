...
public class L22ContactClientList extends Activity {
	...
	protected void onRestart() {
		...
		progress.show();
		l = (LinearLayout) findViewById(R.id.LLContactView_lawyer);
		
		nodatatv= (TextView) findViewById(R.id.L22NODATA);
		nodatatv.setVisibility(View.INVISIBLE);
		nodatall= (LinearLayout) findViewById(R.id.L22NODATALL);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_l22_contact_client_list);
	...
	public void getClientName() {
		...
		try {
			...
			ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
					Client_names);
			ListView lv = (ListView) findViewById(R.id.lstLcontactviewall_lawyer);
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					Intent i = new Intent(getApplicationContext(), L22ContactClient.class);
					i.putExtra("clientid", POS);
					startActivity(i);
				}
			});
		} catch (Exception e) {
...
//		builder.setTitle("No Clients");
//		builder.setCancelable(false).setMessage("Add Clients!!").setPositiveButton("OK", dialogClickListener2)
//				.show();
	}
