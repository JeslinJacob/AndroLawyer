...
public class L33ChatClientList extends Activity {
	...
	protected void onRestart() {
		...
		progress.setMessage("Generating All Clients..");
		progress.setProgressStyle(ProgressDialog.STYLE_SPINNER);
		progress.setCancelable(false);
		progress.setCanceledOnTouchOutside(false);
		progress.show();
		l = (LinearLayout) findViewById(R.id.LL33CHATCLIST);
		nodatatv = (TextView) findViewById(R.id.L33NODATA);
		nodatatv.setVisibility(View.INVISIBLE);
		nodatall = (LinearLayout) findViewById(R.id.L33NODATALL);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_l33_chat_client_list);
	...
	public void getClientid() {
		...
		try {
			...
			HttpPost request = new HttpPost("http://" + changedIP + ":8080/AndroLawyer/GetFromAppClientIdWithLid.jsp");
	...
	public void getClientName() {
		...
		try {
			...
			HttpPost request = new HttpPost(
					"http://" + changedIP + ":8080/AndroLawyer/GetFromAppClientNameWithLid.jsp");
			List<NameValuePair> PostParameters = new ArrayList<NameValuePair>();
			PostParameters.add(new BasicNameValuePair("fLid", Lid));
			UrlEncodedFormEntity formEntity = new UrlEncodedFormEntity(PostParameters);
			request.setEntity(formEntity);
			...
			ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
					Client_names);
			ListView lv = (ListView) findViewById(R.id.LList33CHATCLIST);
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					POS = Client_ids[position];

					System.out.println("PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP  : " + Client_ids[position]);
