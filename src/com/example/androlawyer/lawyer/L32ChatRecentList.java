...
public class L32ChatRecentList extends Activity {
	...
	protected void onRestart() {
		...
		fromid = mypref.getString("lawyerid", null);
		...
		progress.show();
		l = (LinearLayout) findViewById(R.id.LL32CHATLIST);
		nodatatv = (TextView) findViewById(R.id.L32NODATA);
		nodatatv.setVisibility(View.INVISIBLE);
		nodatall = (LinearLayout) findViewById(R.id.L32NODATALL);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_l32_chat_recent_list);
	...
	public void getRecentid() {
		...
		try {
			...
			HttpPost request = new HttpPost("http://" + changedIP + ":8080/AndroLawyer/GetRecentChatIds.jsp");
	...
	public void getRecentName() {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost("http://" + changedIP + ":8080/AndroLawyer/GetRecentChatNames.jsp");
			List<NameValuePair> PostParameters = new ArrayList<NameValuePair>();
			PostParameters.add(new BasicNameValuePair("fLid", fromid));
			UrlEncodedFormEntity formEntity = new UrlEncodedFormEntity(PostParameters);
			request.setEntity(formEntity);
			...
			ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
					recent_names);
			ListView lv = (ListView) findViewById(R.id.LList32CHATLIST);
