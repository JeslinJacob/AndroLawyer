...
public class C24ViewLawyerList extends Activity {
	...
	protected void onRestart() {
		...
		progress.show();
		l = (LinearLayout) findViewById(R.id.Lcontactviewall_c24_lawyer);
		
		nodatatv= (TextView) findViewById(R.id.C24NODATA);
		nodatatv.setVisibility(View.INVISIBLE);
		nodatall= (LinearLayout) findViewById(R.id.C24NODATALL);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_c24_view_lawyer_list);
	...
	public void getLawyerName() {
		...
		try {
			...
			ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
					Lawyer_names);
			ListView lv = (ListView) findViewById(R.id.lstLawyersviewall_c24_lawyer);
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					Intent i = new Intent(getApplicationContext(), C24Rating.class);
