...
public class ClientLogin extends Activity implements OnClickListener {
	TextView Lreg;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (session.isLoggedIn()) {
			...
			Intent intent = new Intent(ClientLogin.this, ClientPage.class);
...
//		ab.hide();
		...
		Lreg = (TextView) findViewById(R.id.Cregisterclogin);
	...
	public void onClick(View v) {
		...
		vibr1.vibrate(100);
		Intent i = new Intent(this, ClientReg.class);
		startActivity(i);
	...
	public void signin(View v) {
		...
		Luser = (EditText) findViewById(R.id.Cuserclogin);
		Lpass = (EditText) findViewById(R.id.Cpassclogin);
		...
		if (!user.equals("") && !pass.equals("")) {
			...
			try {
				...
				HttpPost request = new HttpPost("http://" + changedIP + ":8080/AndroLawyer/ClientLogin.jsp");
				List<NameValuePair> PostParameters = new ArrayList<NameValuePair>();

				PostParameters.add(new BasicNameValuePair("Cuser", user));
				PostParameters.add(new BasicNameValuePair("Cpass", pass));
				...
				if (result.equals("Success")) {
					...
					progress.dismiss();
					alert.showAlertDialog(ClientLogin.this, "Login Failed!!", "Incorrect Username or password", false);
				...
				e.printStackTrace();
				progress.dismiss();
				alert.showAlertDialog(ClientLogin.this, "Login Failed!!", "Please Turn Ur Internet Connection ON",
						false);
			...
			progress.dismiss();
			alert.showAlertDialog(ClientLogin.this, "Login Failed!!", "Enter Both Username & Password", false);
	...
	public void storedata(String user, String pass) {
		...
		try {
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost("http://" + changedIP + ":8080/AndroLawyer/ClientLogin_getCid.jsp");
			...
			edit = mypref.edit();
			edit.putString("clientid", login[0]);
			edit.putString("cname", login[1]);
			edit.commit();
