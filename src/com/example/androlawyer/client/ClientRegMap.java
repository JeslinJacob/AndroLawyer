...
public class ClientRegMap extends Activity {
	EditText searchview;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_client_reg_map);
		disp();
		...
		//bar.setTitle(Html.fromHtml("<font color='#ffffff'>Address Picker</font>"));
		bar.setTitle("Address Picker");
		bar.setIcon(android.R.color.transparent);
		bar.setDisplayHomeAsUpEnabled(true);
		searchview = (EditText) findViewById(R.id.edtSearchclientreg);
		txtadress = (TextView) findViewById(R.id.txtAddressclientreg);
		txtLT = (TextView) findViewById(R.id.txtLTclientreg);
		txtLG = (TextView) findViewById(R.id.txtLGclientreg);
		txtfaddr = (TextView) findViewById(R.id.txtFAddrclientreg);
		btnconfirm = (Button) findViewById(R.id.bttnConfirmclientreg);
		btnSearch = (Button) findViewById(R.id.bttnSearchclientreg);
		...
		map = ((MapFragment) getFragmentManager().findFragmentById(R.id.mapclientreg)).getMap();
