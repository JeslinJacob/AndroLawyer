...
public class C23ContactLawyerList extends Activity {
	...
	protected void onRestart() {
		...
		progress.show();
		l = (LinearLayout) findViewById(R.id.Lcontactviewall_c23_contact);
		
		nodatatv= (TextView) findViewById(R.id.C23NODATA);
		nodatatv.setVisibility(View.INVISIBLE);
		nodatall= (LinearLayout) findViewById(R.id.C23NODATALL);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_c23_contact_lawyer_list);
	...
	public void getLawyerName() {
		...
		try {
			...
			ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,
					Lawyer_names);
			ListView lv = (ListView) findViewById(R.id.lstLawyersviewall_c23_contact);
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					Intent i = new Intent(getApplicationContext(), C23ContactLawyer.class);
